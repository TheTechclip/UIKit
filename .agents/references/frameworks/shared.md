...
**Sources:** [`packages/frameworks/shared`](../../../packages/frameworks/shared)

## Purpose

The `shared` framework folder is a module that collects utility functions, hooks, constants, and shared types commonly depended on by multiple frameworks or components. It includes size conversion, layer constants, scroll lock handling, share layout type definitions, etc.
